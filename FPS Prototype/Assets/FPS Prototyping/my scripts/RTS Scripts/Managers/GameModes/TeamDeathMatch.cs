...
private:
	...
	UFUNCTION(BlueprintCallable, Category = SpawningFactionMembers)
	bool ShouldSpawnFactionMember(TEnumAsByte<EFactions> Faction, int32 FPlayerCount);
	bool isTimeToSpawnReinforcements(TEnumAsByte<EFactions> Faction, int32 FPlayerCount);
	UFUNCTION(BlueprintCallable, Category = SpawningFactionMembers)
